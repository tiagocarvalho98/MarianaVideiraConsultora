...
Use approved/licensed photography only. Do not present generic images as specific real properties unless that has been confirmed.

Recommended files:

- `hero.png` or `hero.jpg`
  - Current: provided editorial reference image.
